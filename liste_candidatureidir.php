...
<div class="row col-12 mt-4 mb-4">
			...
			<div class="row col-12 col-lg-3 mb-4">
					<div class="col-12 border shadow bg-white" id="sidebar-wrapper">
					<h5 class="mb-4 text-center">Liste des candidatures</h5>
					
						<div class="list-group list-group-flush ">
							<a id="toutes_can" href="#" class="list-group-item list-group-item-action ">Toutes les candidatures</a>
							...
							<ul class="collapse list-unstyled " id="homeSubmenu">
								<div class="list-group list-group-flush ">
									<a href="#" class="list-group-item  list-group-item-action">Conditions requises satisfaites</a>
								
							
									<a href="#" class="list-group-item list-group-item-action">Manque d'experiences</a>
								
									<a href="#" class="list-group-item list-group-item-action">Manque de langues</a>

									<a href="#" class="list-group-item list-group-item-action">Manque de compétences</a>
								</div>
							</ul>
							<a href="#" class="list-group-item list-group-item-action">Candidats selectionnés</a>
...
<script src="js/main.js"></script>
 ...
 <script src="https://cdn.datatables.net/1.10.22/js/jquery.dataTables.min.js" type="text/javascript"></script>
   ...
   <script>
		dTable =$('#myTable').DataTable({ info:false,"lengthMenu": [10],
		lengthChange: false,
		responsive: true,
		"ordering": false,
		select: {
