...
?>
		...
		<tr>
			...
			<td><button onClick="validerME('<?php echo $row["id_candidat"]; ?>','<?php echo $row["code_offre"]; ?>','<?php echo $row["email"]; ?>')" class="btn-primary"><i class="fa fa-check"></i></button> <button onClick="refuserME('<?php echo $row["id_candidat"]; ?>','<?php echo $row["code_offre"]; ?>','<?php echo $row["email"]; ?>')" class="btn-danger"><i class="fa fa-times"></i></button></td>
