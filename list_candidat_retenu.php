...
//--------requette pour les candidature-------------
  $reqCnd = "SELECT DISTINCT  c.nom , c.prenom ,c.date_naissance,c.email,c.num_tel FROM candidat c,candidature cd,recruteur r,offre_emploi o WHERE r.id_recruteur='$idr' AND cd.code_offre=o.code_offre AND cd.id_candidat=c.id_candidat AND o.id_recruteur=r.id_recruteur AND cd.reponse='Accepté'";
